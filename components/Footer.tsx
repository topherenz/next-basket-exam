...
const Footer = () => {
    return (
        <footer>
            <div className="w-full flex justify-center bg-[#FAFAFA] text-[#737373] text-sm tracking-[0.0125rem] font-bold">
                <div className="w-full max-w-6xl px-6">
                    <div className="ftr__socials flex justify-between items-center py-10 border-b">
                        <div className="py-3.5 pr-3.5">
                            <span className="text-2xl tracking-[0.0063rem] text-[#252B42]">Bandage</span>
                        </div>
                        <div className="flex justify-center items-center gap-5">
                            <Link href="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M24 11.5704C24 5.1801 18.8515 0 12.5014 0C6.14848 0.00143732 1 5.1801 1 11.5719C1 17.3456 5.2056 22.1319 10.7019 23V14.9151H7.78415V11.5719H10.7048V9.02062C10.7048 6.12155 12.4224 4.52037 15.0484 4.52037C16.3075 4.52037 17.6226 4.74603 17.6226 4.74603V7.59193H16.1724C14.7451 7.59193 14.2995 8.4845 14.2995 9.40008V11.5704H17.4875L16.9787 14.9136H14.2981V22.9986C19.7944 22.1304 24 17.3441 24 11.5704Z" fill="#23A6F0"/>
                                </svg>
                            </Link>
                            <Link href="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                    ...
                    <div className="ftr__links flex flex-col md:flex-row justify-between items-start py-12 gap-7 border-b">
                        <div>
                            <h3 className="text-base text-[#252B42] mb-5">Company Info</h3>
                        ...
                        <div>
                            <h3 className="text-base text-[#252B42] mb-5">Legal</h3>
                            <ul className="flex flex-col gap-2.5">
                                <li>
                                    <Link href="">
                                        <span>About Us</span>
                        ...
                        <div>
                            <h3 className="text-base text-[#252B42] mb-5">Features</h3>
                            <ul className="flex flex-col gap-2.5">
                                <li>
                                    <Link href="">
                        ...
                        <div>
                            <h3 className="text-base text-[#252B42] mb-5">Resources</h3>
                            <ul className="flex flex-col gap-2.5">
                                <li>
                                    <Link href="">
                        ...
                        <div>
                            <h3 className="text-base text-[#252B42] mb-5">Get In Touch</h3>
                            <div>
                                <form>
                                    <div className="flex justify-stretch items-center">
                                        <input 
                                            className="p-3.5 bg-white border rounded-tl-md rounded-bl-md font-normal"
                                            type="email" 
                                            name="email-subscribe" 
                                            placeholder="Your Email" 
                                        />
                                        <button className="p-3.5 rounded-tr-md rounded-br-md font-normal bg-[#23A6F0] text-white" type="submit">Subscribe</button>
                                    </div>
                                </form>
                                <div className="mt-2 text-xs font-normal"><span>Lore imp sum dolor Amit</span></div>
                            </div>
                        </div>
                    </div>
                    <div className="ftr-copyright py-6">
                        <span>Made With Love By Finland. All Rights Reserved.</span>
                    </div>
                </div>
            </div>
        </footer>
